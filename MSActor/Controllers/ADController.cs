    ...
    public class ADController
    {
            ...
            try
            {
                ...
                foreach (PSObject ob in names)
                {
                    if (ob.Properties["samaccountname"].Value != null)
                        searchIdentity = ob.Properties["samaccountname"].Value.ToString();
                    ...
                    ADUserModel toReturn = new ADUserModel(searchCity, searchCountry, searchDepartment, searchDescription, searchDisplayName, searchEmployeeID, searchGivenName, searchOfficePhone, searchInitials, searchOffice, searchPostalCode, searchSamAccountName, searchState, searchStreetAddress, searchSurname, searchTitle, searchUserPrincipalName, searchPath);
                    return toReturn;
                }
                return null;
            }
        ...
        public MSActorReturnMessageModel NewADUserDriver(ADUserModel user)
        {
            try
            {
                ...
                ps.AddParameter("employeeid", user.emplid);
